...
main_path = [
    (6, j)  for j in range(1,7) ]+ [(i,6) for i in range(5,-1,-1)]+[(0,j) for j in range(7,9)] +[(i,8) for i in range(1,7)]+[(6 , j) for j in range(9,15)] + [(i,14) for i in range(7,9)] + [(8,j) for j in range(13,7,-1)]+[(i,8) for i in range(9,15)]+[(14,j) for j in range(7,5,-1)]+[(i,6) for i in range(13,7,-1)]+[(8,j) for j in range(5,-1,-1)] + [(i,0) for i in range(7,5,-1)]
